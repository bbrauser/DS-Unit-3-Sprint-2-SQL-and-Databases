...
# To be clear - this code stillruns on one computer
...
print('Sum of aquared values(traditional):' + str(ssv_trad))
print('Sum of sqaured values (map-reduce):' + str(ssv_mapreduce))